...
// server/fix-correct-import-paths.js
// Script to fix Firebase import paths to use correct relative paths
...
function fixImportPaths(filePath) {
  ...
  // Fix import paths for files in src/ directory
  if (filePath.includes('/src/')) {
    // Replace '../config/firebase.js' with './config/firebase.js' for files in src/
...
console.log('🚀 Fixing Firebase import paths to correct relative paths...');
